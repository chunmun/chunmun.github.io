    ...
    function stringifyEvent(event) {
        stringify = {
            ...
            'INPUT': function(args) {
                ...
                if (!args[1]) {
                    return "<i class='fa fa-gamepad'></i> " + objectify(object) + " just stood around";
                }
            ...
            'KILLED': function(args) {
                ...
                return "<i class='fa fa-minus-circle'></i> <strong>" + objectify(killer) + " killed " + objectify(killed) + "</strong>";
            },
            ...
            'LOAD': function(args) {
                ...
                if (success) {
                    return objectify(tribute) + " loaded " + objectify(weapon) + " with " + objectify(ammo);
                } else {
                    return objectify(tribute) + " cannot load " + objectify(weapon) + " with " + objectify(ammo);
                }
            }
        }
